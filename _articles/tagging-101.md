...
When we want to tag some content, we surround it with a matching pair of words, each word surrounded by  a set of brackets “< >”. Here’s an example tag: <title> Tag the World </title>
