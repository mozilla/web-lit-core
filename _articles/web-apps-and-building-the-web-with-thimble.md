...
1. Introduction/discussion: What are web applications? [5-7 min]
...
Ask learners, what are examples of static pages? Think of sites that don’t have new content often, or ever. Or sites with very few pages. Tip! Examples might be DMV site, small restaurant, etc. These websites are designed primarily to convey information. 
...
2. Meet Thimble, Take A Tour [5-7 min]
...
Learners who create their own personal pages in Thimble can return to them and add content, esp do the Project Playlist or All the Stickers activities in the “Participate” section. 

4. Wrap-up & Optional Discussion Topics [10 mins]
Choose one of the topics below to wrap up the activity:

Sharing Code & Remixing with Thimble
If learners worked with their own stories, introduce them to remixable projects and the Tutorial tab, and let them explore and play for 5 or 10 minutes. If they remixed an existing project, have a discussion about that experience: 
Ask learners
...
5. Pros and Cons of Thimble vs Composing Offline
...
7. Learning Experience Reflection [5 mins]
